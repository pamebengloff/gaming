 ...
 * @author rnavarro
 */
public class G_LeaguesTableListener implements TableModelListener  {
    
    private final Database db;
    
    public G_LeaguesTableListener(Database d) {
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event) {
        ...
        String sql = String.format(
                "UPDATE games_have_leagues SET %s = %s WHERE league_id = \'%s\'",
                colSQLName,
